...
// }
//
// if (!SDL_CreateWindowAndRenderer(filename.c_str(), hdr_data.width, hdr_data.height, SDL_WINDOW_RESIZABLE, &window,
// &renderer)) { SDL_Log("Couldn't create window/renderer: %s", SDL_GetError()); return SDL_APP_FAILURE;
// }
//
